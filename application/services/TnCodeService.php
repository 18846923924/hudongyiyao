...
class TnCodeService
{
    ...
    private function _init(){
        ...
        $file_bg = Env::get('root_path').'/public/static/tn/bg/'.$bg.'.png';
    ...
    private function _createBg(){
        $file_mark = Env::get('root_path').'/public/static/tn/img/mark.png';
    ...
    private function _createSlide(){
        $file_mark = Env::get('root_path').'/public/static/tn/img/mark2.png';
