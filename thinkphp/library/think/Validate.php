...
class Validate
{
    ...
    protected static $typeMsg = [
        ...
        'mobile1'      => ':attribute not a valid mobile',
        'mobMail'      => ':attribute not a valid mobile or email',
    ...
    protected $defaultRegex = [
        ...
        'mobile1'      => '/^1[0-9][0-9]\d{8}$/',
        'mobMail'      => '/(^0{0,1}(13[0-9]|15[7-9]|153|156|18[7-9])[0-9]{8}$)|(^[a-z0-9!#$%&\'*+\/=?^_`{|}~.-]+@[a-z0-9]([a-z0-9-]*[a-z0-9])?(\.[a-z0-9]([a-z0-9-]*[a-z0-9])?)*$) /i',
